...
if($lib->checkCompleteArgument(['unique_id','promotion_id'],$dataComing)){
	$arrayGroup = array();
	...
	$fetchPromotion = $conmysql->prepare("SELECT 
											...
											WHERE promotion_id =:promotion_id AND is_use = '1'
											");
	$fetchPromotion->execute(['promotion_id' => $dataComing["promotion_id"]]);
