...
if($lib->checkCompleteArgument(['unique_id'],$dataComing)){
	if($func->check_permission_core($payload,'sms','reportnotifysuccess')){
		...
		$fetchReport = $conmysql->prepare("SELECT id_history, his_title, his_detail, his_path_image, member_no, receive_date, send_by, id_smstemplate, is_sendahead FROM lbhistory WHERE 1=1
