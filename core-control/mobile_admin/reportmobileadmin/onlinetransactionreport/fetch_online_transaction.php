...
if($lib->checkCompleteArgument(['unique_id'],$dataComing)){
	if($func->check_permission_core($payload,'mobileadmin','onlinetransactionreport')){
		...
		$getDeptType = $conmssql->prepare("select deptitemtype_code,deptitemtype_desc,sign_flag from dpucfdeptitemtype");
		$getDeptType->execute();
		while($rowDeptItemType = $getDeptType->fetch(PDO::FETCH_ASSOC)){
		...
		$arrayResult['Queeeery'] =  $rowDeptItemType = $getDeptType->fetch(PDO::FETCH_ASSOC);
