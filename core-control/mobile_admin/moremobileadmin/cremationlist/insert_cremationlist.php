...
if($lib->checkCompleteArgument(['unique_id','full_name','data_date'],$dataComing)){
	if($func->check_permission_core($payload,'mobileadmin','cremationlist')){
		...
		$insertCremationList = $conmysql->prepare("INSERT INTO gccremationlist (full_name, data_date,cremation_amt , update_user) VALUES (:full_name, :data_date ,:cremation_amt, :update_user)");
