...
if($lib->checkCompleteArgument(['unique_id'],$dataComing)){
	if($func->check_permission_core($payload,'log','logwithdrawerror')){
		$arrayGroup = array();
		$fetchLogWithdrawError = $conmysql->prepare("SELECT wd.id_withdrawtransbankerr,wd.member_no,wd.transaction_date,wd.amt_transfer,wd.penalty_amt,wd.penalty_amt,wd.fee_amt,
														wd.fee_amt,wd.deptaccount_no,wd.response_code,wd.response_message,login.channel,login.device_name
