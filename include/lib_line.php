...
class libraryLine {
	...
	public function coopMenu(){
		$dataTemplate = array();
		$dataTemplate["type"] = "imagemap";
		$dataTemplate["baseUrl"] = "https://cdn.thaicoop.co/linebot/imagemap/1040.png?_ignored=";
		$dataTemplate["altText"] = "เมนูสหกรณ์";
		$dataTemplate["baseSize"]["width"] = 1040;
		$dataTemplate["baseSize"]["height"] = 1040;
		$dataTemplate["actions"][0]["type"] = "message";
		$dataTemplate["actions"][0]["area"]["x"] = 0;
		$dataTemplate["actions"][0]["area"]["y"] = 0;
		$dataTemplate["actions"][0]["area"]["width"] = 350;
		$dataTemplate["actions"][0]["area"]["height"] = 216;
		$dataTemplate["actions"][0]["text"] = "ข้อมูลส่วนตัว";
		$dataTemplate["actions"][1]["type"] = "message";
		$dataTemplate["actions"][1]["area"]["x"] = 356;
		$dataTemplate["actions"][1]["area"]["y"] = 3;
		$dataTemplate["actions"][1]["area"]["width"] = 339;
		$dataTemplate["actions"][1]["area"]["height"] = 210;
		$dataTemplate["actions"][1]["text"] = "เงินฝาก";
		$dataTemplate["actions"][2]["type"] = "message";
		$dataTemplate["actions"][2]["area"]["x"] = 698;
		$dataTemplate["actions"][2]["area"]["y"] = 5;
		$dataTemplate["actions"][2]["area"]["width"] = 342;
		$dataTemplate["actions"][2]["area"]["height"] = 209;
		$dataTemplate["actions"][2]["text"] = "เงินกู้";
		$dataTemplate["actions"][3]["type"] = "message";
		$dataTemplate["actions"][3]["area"]["x"] = 1;
		$dataTemplate["actions"][3]["area"]["y"] = 217;
		$dataTemplate["actions"][3]["area"]["width"] = 348;
		$dataTemplate["actions"][3]["area"]["height"] = 201;
		$dataTemplate["actions"][3]["text"] = "หุ้น";
		$dataTemplate["actions"][4]["type"] = "message";
		$dataTemplate["actions"][4]["area"]["x"] = 355;
		$dataTemplate["actions"][4]["area"]["y"] = 216;
		$dataTemplate["actions"][4]["area"]["width"] = 342;
		$dataTemplate["actions"][4]["area"]["height"] = 200;
		$dataTemplate["actions"][4]["text"] = "ค้ำประกัน";
		$dataTemplate["actions"][5]["type"] = "message";
		$dataTemplate["actions"][5]["area"]["x"] = 702;
		$dataTemplate["actions"][5]["area"]["y"] = 217;
		$dataTemplate["actions"][5]["area"]["width"] = 337;
		$dataTemplate["actions"][5]["area"]["height"] = 198;
		$dataTemplate["actions"][5]["text"] = "เรียกเก็บ";
		$dataTemplate["actions"][6]["type"] = "message";
		$dataTemplate["actions"][6]["area"]["x"] = 0;
		$dataTemplate["actions"][6]["area"]["y"] = 420;
		$dataTemplate["actions"][6]["area"]["width"] = 346;
		$dataTemplate["actions"][6]["area"]["height"] = 207;
		$dataTemplate["actions"][6]["text"] = "ปันผล-เฉลี่ยคืน";
		$dataTemplate["actions"][7]["type"] = "message";
		$dataTemplate["actions"][7]["area"]["x"] = 352;
		$dataTemplate["actions"][7]["area"]["y"] = 424;
		$dataTemplate["actions"][7]["area"]["width"] = 341;
		$dataTemplate["actions"][7]["area"]["height"] = 200;
		$dataTemplate["actions"][7]["text"] = "สิทธิ์กู้โดยประมาณ";
		$dataTemplate["actions"][8]["type"] = "message";
		$dataTemplate["actions"][8]["area"]["x"] = 696;
		$dataTemplate["actions"][8]["area"]["y"] = 425;
		$dataTemplate["actions"][8]["area"]["width"] = 344;
		$dataTemplate["actions"][8]["area"]["height"] = 198;
		$dataTemplate["actions"][8]["text"] = "ผู้รับผลประโยนช์";
		$dataTemplate["actions"][9]["type"] = "message";
		$dataTemplate["actions"][9]["area"]["x"] = 1;
		$dataTemplate["actions"][9]["area"]["y"] = 629;
		$dataTemplate["actions"][9]["area"]["width"] = 348;
		$dataTemplate["actions"][9]["area"]["height"] = 202;
		$dataTemplate["actions"][9]["text"] = "สวัสดิการ";
		$dataTemplate["actions"][10]["type"] = "message";
		$dataTemplate["actions"][10]["area"]["x"] = 354;
		$dataTemplate["actions"][10]["area"]["y"] = 628;
		$dataTemplate["actions"][10]["area"]["width"] = 339;
		$dataTemplate["actions"][10]["area"]["height"] = 204;
		$dataTemplate["actions"][10]["text"] = "ประกัน";
		$dataTemplate["actions"][11]["type"] = "message";
		$dataTemplate["actions"][11]["area"]["x"] = 695;
		$dataTemplate["actions"][11]["area"]["y"] = 627;
		$dataTemplate["actions"][11]["area"]["width"] = 343;
		$dataTemplate["actions"][11]["area"]["height"] = 207;
		$dataTemplate["actions"][11]["text"] = "ตารางประมาณการ";
		$dataTemplate["actions"][12]["type"] = "message";
		$dataTemplate["actions"][12]["area"]["x"] = 0;
		$dataTemplate["actions"][12]["area"]["y"] = 834;
		$dataTemplate["actions"][12]["area"]["width"] = 349;
		$dataTemplate["actions"][12]["area"]["height"] = 204;
		$dataTemplate["actions"][12]["text"] = "ใบเสร็จ";
		$dataTemplate["actions"][13]["type"] = "message";
		$dataTemplate["actions"][13]["area"]["x"] = 353;
		$dataTemplate["actions"][13]["area"]["y"] = 835;
		$dataTemplate["actions"][13]["area"]["width"] = 341;
		$dataTemplate["actions"][13]["area"]["height"] = 201;
		$dataTemplate["actions"][13]["text"] = "ฌาปนกิจ";
		$dataTemplate["actions"][14]["type"] = "message";
		$dataTemplate["actions"][14]["area"]["x"] = 695;
		$dataTemplate["actions"][14]["area"]["y"] = 836;
		$dataTemplate["actions"][14]["area"]["width"] = 344;
		$dataTemplate["actions"][14]["area"]["height"] = 203;
		$dataTemplate["actions"][14]["text"] = "ข่าวสาร";
		return $dataTemplate;
	}	
	//Kfinance
	public function flexExData(){
		...
		$dataTemplate["contents"]["body"]["contents"][6]["contents"][0]["contents"][1]["text"] = "ดูเพิ่มเติม";
		...
		$dataTemplate["contents"]["body"]["contents"][6]["action"]["type"] = "uri";
		$dataTemplate["contents"]["body"]["contents"][6]["action"]["label"] = "action";
		$dataTemplate["contents"]["body"]["contents"][6]["action"]["uri"] = "https://cdn.thaicoop.co/gensoft/%E0%B8%82%E0%B9%89%E0%B8%AD%E0%B8%A1%E0%B8%B9%E0%B8%A5.pdf";
		return $dataTemplate;
	}
	//Kfinance
	...
	$dataTemplate = array();
	$dataTemplate["type"] = "flex";
	$dataTemplate["altText"] = "ใบเสร็จรับเงิน";
	$dataTemplate["contents"]["type"] = "bubble";
	$dataTemplate["contents"]["body"]["type"] = "box";
	$dataTemplate["contents"]["body"]["layout"] = "vertical";
	$dataTemplate["contents"]["body"]["contents"][0]["type"] = "text";
