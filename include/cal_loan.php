...
class CalculateLoan {
	...
	$tofrom_accid,$slipwtd,$log,$lib,$payload,$from_account_no,$lnslip_no,$member_no,$ref_no,$app_version){
		...
		if($updateInterestAccum->execute([
			':int_accum' => $interest_accum + $interest["INT_PERIOD"],
			':member_no' => $member_no
		])){
	...
	$tofrom_accid,$slipwtd=null,$log,$lib,$payload,$from_account_no,$payinslip_no,$member_no,$ref_no,$itemtypeWTD,$conmysql,$penalty_amt=0,$bank_code=null){
		$interest_accum = $this->calculateIntAccum($member_no);
