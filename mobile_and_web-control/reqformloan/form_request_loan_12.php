...
function GeneratePDFContract($data,$lib) {
	$html = '
		    ...
		    <body>
				...
				<div class="extend" id="int_rate"><b>'.$data["int_rate"].'</b></div>
			...
			ขอเสนอกู้ฉุกเฉินปันผลดำรงชีพออนไลน์ดังต่อไปนี้<br>
			...
			ในเดือนถัดไป กรณีที่เงินปันผลและเงินเฉลี่ยคืนถูกบังคับคดี สมาชิกต้องนำหนี้เงินต้น (ฉป) พร้อมดอกเบี้ยส่งชำระคืนสหกรณ์ในทันที
			<div class="nowrap">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;การจ่ายเงินกู้ให้แก่ข้าพเจ้า ข้าพเจ้ายินยอมให้โอนเงินกู้เข้าบัญชีเงินฝากออมทรัพย์ ATM (เล่มฟ้า) เลขที่...............................</div>
			ถือว่าเป็นอันเสร็จสิ้นสมบูรณ์ว่าข้าพเจ้าได้รับเงินกู้ไว้ถูกต้องแล้ว<br>
			<div style="letter-spacing:0.17" class="nowrap">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ข้าพเจ้าผู้กู้ได้อ่านและรับทราบข้อกำหนดและเงื่อนไขในการใช้บริการขอกู้ฉุกเฉินปันผลดำรงชีพออนไลน์ของสหกรณ์</div>
			<div style="letter-spacing:0.10" class="nowrap">ตาม "ข้อกำหนด และเงื่อนไขการใช้บริการขอกู้ฉุกเฉินปันผลดำรงชีพออนไลน์ต่อท้ายสัญญา" ในวันที่ทำคำขอนี้แล้วและตกลงยินยอม</div>
			<div style="letter-spacing:0.17" class="nowrap">ผูกพันและรับปฏิบัติตาม ข้อกำหนดและเงื่อนไขดังกล่าวหากข้าพเจ้าไม่ปฏิบัติตามข้อกำหนดและเงื่อนไขดังกล่าวจนเป็นเหตุให้</div> 
			<div>เกิดความเสียหายใด ๆ ข้าพเจ้า ยินยอมรับผิดชอบทั้งสิ้น โดยถือว่าข้าพเจ้าเป็นผู้ผิดสัญญาในการกู้ยืมเงินฉบับนี้</div>
		   </div>
		    <div class="right">
			ลงชื่อ........................................................ผู้ขอกู้<br>
			ติดต่อ.................................................................<br>
