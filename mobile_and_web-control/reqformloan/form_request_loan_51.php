...
function GeneratePDFContract($data,$lib) {
	...
	$html .= '
		...
		<div style="font-size: 22px;font-weight: bold; text-align:center; margin-center:30px; height: 45px; margin-top:10px;">คำขอกู้และสัญญาเงินกู้สามัญไม่ใช้ผู้ค้ำ</div>
		<div>
