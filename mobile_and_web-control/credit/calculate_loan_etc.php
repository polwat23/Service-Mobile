...
$fetchCredit = $conmssql->prepare("SELECT  lt.loantype_code as LOANTYPE_CODE,lt.loantype_desc AS LOANTYPE_DESC,lc.maxloan_amt,lc.MULTIPLE_SHARE as PERCENTSHARE,lc.STARTSALARY_AMT as PERCENTSALARY
