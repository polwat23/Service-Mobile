...
$fetchCredit = $conoracle->prepare("SELECT	
									l.maxloan_amt as MAXLOAN_AMT ,
									s.sharestk_amt*sh.unitshare_value*l.multiple_share AS SHARE_AMT,
									NVL(m.salary_amount,15000)*l.multiple_salary AS SALARY_AMOUNT
									FROM lnloantypecustom l LEFT JOIN lnloantype lt ON l.loantype_code = lt.loantype_code,
									shsharemaster s LEFT JOIN mbmembmaster m ON s.member_no=m.member_no,shsharetype sh
									...
									GROUP BY l.maxloan_amt,s.sharestk_amt*sh.unitshare_value*l.multiple_share,NVL(m.salary_amount,15000)*l.multiple_salary");
$fetchCredit->execute([
	':member_no' => $member_no,
