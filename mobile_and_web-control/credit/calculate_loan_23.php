...
$request_amt = 0;
	...
	$arrSubOtherInfo = array();
	$arrSubOtherInfo["LABEL"] = "ผู้กู้ที่ขอกู้เงินไม่เกิน 50,000 บาท ต้องมีผู้ค้ำประกันไม่น้อยกว่า";
	$arrSubOtherInfo["VALUE"] = " 1 คน";
	$arrOtherInfo[] = $arrSubOtherInfo;
	$arrSubOtherInfo = array();
	$arrSubOtherInfo["LABEL"] = "ผู้กู้ที่ขอกู้เงินเกินกว่า 50,000 บาท ต้องมีผู้ค้ำประกันไม่น้อยกว่า";
