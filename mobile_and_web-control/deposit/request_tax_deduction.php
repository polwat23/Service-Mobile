	...
	* {
	...
	$html .= '
		...
		<div style="height:25px;">
		  ...
		  <div style="position:absolute; top:101px; left:210px;" class="font-bold">
			  ในแบบ
		  </div>
		</div>
	...
	//ใบแนบ
	$html .= '
	<div style="position:absolute; top:270px; right:0;">
	...
	<div style="position:absolute; top:290px; right:91px;">
	...
	//ตารางการจ่าย
	$html .= '
	<div style="position:absolute; top:323px; left:-20px; border-left:1px solid; border-right:1px solid; border-top:1px solid;  solid; border-radius:5px 5px 0px 0px; margin-right:20px; ">
	   <table >
		  <thead>
			<tr>
		  ...
		  <tr>
				...
				<td class="border-dotted text-right padding-rihgt font-bold">'.number_format($arrayData["ADC_PAYAMT"],2).'</td>
				<td class="border-dotted text-right padding-rihgt font-bold" style="border-right:none;width: 93px;">'.number_format($arrayData["ADC_PAYTAX"],2).'</td>
		  </tr>
				<tr>
		   ...
		   <tr>
				...
				<div style="text-indent:18px; "; >กําไรสุทธิของกิจการที่ต้องเสียภาษีเงินได้นิติบุคคลในอัตราดังนี้</div> 
				</td>
				<td class="text-center font-bold"></td>
				<td class="text-right padding-rihgt font-bold"></td>
				<td class="text-right padding-rihgt font-bold" style="border-right:none;"></td>
		  ...
		  <tr>
			  ...
			  <td class="text-right padding-rihgt font-bold" style="border-bottom:solid 2px">'.number_format($arrayData["ADC_PAYAMT"],2).'</td>
			  <td class="text-right padding-rihgt font-bold" style="border-bottom:solid 2px" style="border-right:none;width: 93px;">'.number_format($arrayData["ADC_PAYTAX"],2).'</td>
	...
	//เส้น สตางค์
	$html .= '
	  <div style="border-left:1px solid;  height:465px;  position:fixed;  left:588px; top:362px; width:18px;">

	  </div>
	  <div style="border-left:1px solid;  width:18px; height:465px;  position:fixed;   left:704px; top:362px;">
		
	  </div>
	';

	$html .= '
	<div style="position:absolute; bottom:205px; left:-20px; border:1px solid; border-radius:3px; margin-right:20px; width:100%; height:56px;">
	   ...
	   <div style="border:1px solid; width:500px; position:absolute; top:18px; right:1px; padding-left:30px; padding-top:5px; padding-bottom:5px;" class="font-bold">'.$lib->baht_text($arrayData["ADC_PAYTAX"]).'</div>
	</div>
	';

	$html .= '
	<div style="position:absolute; bottom:181px; left:-20px; border:1px solid ; border-radius:3px; margin-right:20px; width:100%; padding-top:-3px; padding-left:7px; ">
	...
	$html .= '
	<div style="position:absolute; bottom:158px; left:-20px; border:1px solid;  border-radius:3px; margin-right:20px; width:100%; padding-top:-3px; padding-left:7px; ">
		<b>ผู้จ่ายเงิน</b>   
	</div>
	';
	...
	$html .= '
	<div style="position:absolute; bottom:159px; left:40px;  margin-right:20px; width:100%; padding-top:-3px; ">
	...
	$html .= '
	<div  style="position:absolute; bottom:61px; left:-20px;   margin-right:20px; width:240px; height:95px;  padding-left:8px; padding-left:8px;">
	  <b>คำเตือน</b>
	</div>
	<div style="position:absolute; bottom:60px; left:-20px;   margin-right:20px; width:240px; height:95px;  border-radius:3px; border:1px solid  ; padding-left:70px;">
	...
	<div style="position:absolute; bottom:60px; right:-40px;   margin-right:20px; width:426px; height:95px;  border-radius:3px; border:1px solid ;">
		...
		<div class="text-center" style="position:absolute; line-height:9px; font-size:14px; top:27px; right:0px; width:60px; height:60px; border:1px solid; border-radius:180%; text-align:center; line-height:12px;border-collapse: separate;">
		
		</div> 
		<div style="position:absolute; line-height:9px; font-size:14px; top:35px; right:0px; width:60px;text-align:center; line-height:12px; ">
