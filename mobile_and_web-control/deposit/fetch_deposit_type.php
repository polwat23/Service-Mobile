...
if($lib->checkCompleteArgument(['menu_component'],$dataComing)){
	if($func->check_permission($payload["user_type"],$dataComing["menu_component"],'DepositInfo')){
		...
		$getAccount = $conoracle->prepare("SELECT dp.depttype_code,dt.depttype_desc,TRIM(dp.deptaccount_no) as deptaccount_no,dp.deptaccount_name,dp.prncbal as BALANCE,
