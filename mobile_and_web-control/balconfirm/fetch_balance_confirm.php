...
if($lib->checkCompleteArgument(['menu_component'],$dataComing)){
	if($func->check_permission($payload["user_type"],$dataComing["menu_component"],'BalanceConfirm')){
		...
		$arrGrpAllLoan = array();
		$arrGrpLoanAll = array();
		$getSumAllDept = $conoracle->prepare("SELECT DISTINCT  dt.depttype_desc,dp.deptaccount_no,dp.deptaccount_name,dp.prncbal as BALANCE
											...
											GROUP BY dt.depttype_desc,dp.deptaccount_no,dp.deptaccount_name,dp.prncbal
