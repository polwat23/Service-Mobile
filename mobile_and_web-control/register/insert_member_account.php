...
if($lib->checkCompleteArgument(['user_type'],$payload) && $lib->checkCompleteArgument(['member_no','email','phone','password','api_key','unique_id','menu_component'],$dataComing) && $anonymous){
