...
if($lib->checkCompleteArgument(['member_no','id_card','api_token','unique_id'],$dataComing)){
	...
	$userTest[]['member_no'] = "00000282";
	$userTest[]['member_no'] = "00000792";
	$userTest[]['member_no'] = "00001372";
	$userTest[]['member_no'] = "00002474";
	$userTest[]['member_no'] = "00000785";
	...
	if($checkMember->rowCount() > 0){
		...
		$checkValid = $conoracle->prepare("SELECT mb.ADDR_MOBILEPHONE as MEM_TELMOBILE , mb.memb_name,mb.memb_surname,mb.resign_status,mp.prename_desc,trim(mb.card_person) as card_person
