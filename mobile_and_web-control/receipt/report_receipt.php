...
$sumBalance = 0;
	...
	$html .= '<p style="margin-top: -30px;font-size: 22px;font-weight: bold">สหกรณ์ออมทรัพย์ตำรวจภูธรจังหวัดอุตรดิตถ์ จำกัด</p>
				<p style="margin-top: -27px;font-size: 18px;">191 หมู่ 9 ตำบลน้ำริด อำเภอเมือง จังหวัดอุตรดิตถ์ 53000</p>
			...
			<div>
				...
				<div style="height: 270px; border-left:1px solid; margin-left:-0.5px; border-right:1px solid; margin-right:-0.5px;">
					...
					<table style=" border-collapse: collapse; width:100%">';		
						...
						foreach($dataReport as $data){
							$html .='
											...
											<tr>
												<td class="table-data"  style="width:350.5px" >'.($data["TYPE_DESC"]??null).' '.$dataReport[$i]["PAY_ACCOUNT"].'</td>
												<td class="center table-data " style="width:80.5px">'.($data["PERIOD"]??null).'</td>
												<td class="right table-data " style="width:97.5px">'.($data["PRN_BALANCE"]??null).'</td>
												<td class="right table-data " style="width:107px">'.($data["INT_BALANCE"]??null).'</td>
												<td class="right table-data " style="width:124.5px">'.($data["ITEM_PAYMENT"]??null).'</td>
												<td class="right table-data ">'.($data["ITEM_BALANCE"]??null).'</td>
											</tr>
							';
			...
			<div style="display:flex;">
				<div style="width:500px;font-size: 18px;">
					หมายเหตุ : ใบรับเงินประจำเดือนจะสมบูรณ์ก็ต่อเมื่อทางสหกรณ์ได้รับเงินที่เรียกเก็บเรียบร้อยแล้ว<br>ติดต่อสหกรณ์ โปรดนำ 1. บัตรประจำตัว 2. ใบเสร็จรับเงิน 3. สลิปเงินเดือนมาด้วยทุกครั้ง
				</div>
