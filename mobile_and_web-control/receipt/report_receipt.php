...
function GenerateReport($dataReport,$header,$lib){
	...
	$html .= '<p style="margin-top: -30px;font-size: 22px;font-weight: bold">สหกรณ์ออมทรัพย์โรงพยาบาลอุตรดิตถ์ จำกัด</p>
			<p style="margin-top: -27px;font-size: 18px;">40/33 ถนนเจษฎาบดินทร์ ตำบลท่าอิฐ</p>
			<p style="margin-top: -25px;font-size: 18px;">อำเภอเมือง จังหวัดอุตรดิตถ์ 53000</p>
			<p style="margin-top: -25px;font-size: 18px;">โทร : 055-444358 , 089-6441921 โทรภายใน 2007,2008</p>
			<p style="margin-top: -27px;font-size: 19px;font-weight: bold">www.uttsavings.com</p>
			</div>
			</div>
