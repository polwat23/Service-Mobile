...
function GenerateReport($dataReport,$header,$lib){
	...
	$html .= '<div style="display:flex;width: 100%;height: 40px" class="sub-table">
			...
			<div style="font-size: 18px;margin-left: 650px;margin-top:-60px;">(นายนัจรินทร์  อัมพรมหา)</div>
			<div style="font-size: 18px;margin-left: 690px;margin-top:0px;">ผู้จัดการ</div>
			';
