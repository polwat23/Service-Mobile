...
function GenerateReport($dataReport,$header,$lib){
	...
	$html .= '<div style="display:flex;width: 100%;height: 40px" class="sub-table">
			...
			<img src="../../resource/utility_icon/signature/president.gif" width="70" height="50" style="margin-top:10px;"/>
			</div>
			<div style="width:200px;margin-left: 680px;display:flex;">
			<img src="../../resource/utility_icon/signature/vice_president.gif" width="100" height="50" style="margin-top:10px;"/>
			</div>
			<div style="width:200px;margin-left: 830px;display:flex;">
			<img src="../../resource/utility_icon/signature/recv_staff.jpg" width="100" height="50" style="margin-top:10px;"/>
			</div>
			</div>
			<div style="font-size: 18px;margin-left: 520px;margin-top:-160px;">ประธานกรรมการ</div>
			<div style="font-size: 18px;margin-left: 660px;margin-top:-160px;">รองประธานหรือเลขานุการ</div>
