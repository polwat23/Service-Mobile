...
function GenerateReport($dataReport,$header,$lib){
	...
	$html = '<style>
			...
			<div style="display: flex;text-align: center;position: relative;margin-bottom: 20px;">
				...
				<p style="margin-top: -30px;font-size: 22px;font-weight: bold">สหกรณ์ออมทรัพย์กรมทางหลวง จำกัด</p>
				<p style="margin-top: -27px;font-size: 18px;">อาคาร 26  2/486 ถนนศรีอยุธยา แขวงทุ่งพญาไท เขตราชเทวี กรุงเทพมหานคร 10400</p>
