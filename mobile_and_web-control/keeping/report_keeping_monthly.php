...
function GenerateReport($dataReport,$header,$lib){
	...
	$html = '<style>
			...
			<div style="display: flex;text-align: center;position: relative;margin-bottom: 20px;">
				...
				<p style="margin-top: -30px;font-size: 22px;font-weight: bold">สหกรณ์ออมทรัพย์การทางพิเศษแห่งประเทศไทย จำกัด</p>
				<p style="margin-top: -27px;font-size: 18px;">111 ถนนริมคลองบางกะปิ แขวงบางกะปิ เขตห้วยขวาง กรุงเทพฯ 10310</p>
				<p style="margin-top: -25px;font-size: 18px;">โทร. 092-647-4649</p>
				<!-- <p style="margin-top: -27px;font-size: 19px;font-weight: bold">www.</p> -->
				</div>
			</div>
