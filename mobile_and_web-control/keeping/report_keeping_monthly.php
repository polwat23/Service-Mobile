...
function GenerateReport($dataReport,$header,$lib){
	...
	$html = '<style>
			...
			<div style="display: flex;text-align: center;position: relative;margin-bottom: 20px;">
				...
				<p style="margin-top: -30px;font-size: 22px;font-weight: bold">สหกรณ์ออมทรัพย์ครูประจวบคีรีขันธ์ จำกัด</p>
	...
	$html .= '<div style="display:flex;width: 100%;height: 40px" class="sub-table">
			...
			.....................................
			<p style="margin-left: 10px;">ประธานกรรมการ</p></div>
			<div style="font-size: 18px;margin-left: 670px;margin-top:-90px;">
			............................................
			<p style="margin-left: 0px;">รองประธานหรือเลขานุการ</p></div>
			<div style="font-size: 18px;margin-left: 850px;margin-top:-90px;">
			.....................................
