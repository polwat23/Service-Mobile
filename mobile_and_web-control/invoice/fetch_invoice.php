		...
		if($end_date > $datenow){
			...
			if($rowBalIs_VIEW["IS_VIEW"] == '1'){
				if($Contractno == "0"){
					...
					$arrayResult['ADVICE'] = "หากสหกรณ์มีการรับเงินกู้หรือมีการชำระเงินกู้พิเศษหลังจากวันที่พิมพ์ด้านมุมบนขวา  กรุณาตรวจสอบยอดชำระอีกครั้ง หลังจากสหกรณ์ทำรายการเสร็จสิ้นเเล้วถัดไปอีก  3  วันทำการ  หรือติดต่อเจ้าหน้าที่  ชสอ.";
				...
				$arrayResult['WAITING_CONFIRM '] = "หากสหกรณ์มีการรับเงินกู้หรือมีการชำระเงินกู้พิเศษหลังจากวันที่พิมพ์ด้านมุมบนขวา  กรุณาตรวจสอบยอดชำระอีกครั้ง หลังจากสหกรณ์ทำรายการเสร็จสิ้นเเล้วถัดไปอีก  3  วันทำการ  หรือติดต่อเจ้าหน้าที่  ชสอ.";
