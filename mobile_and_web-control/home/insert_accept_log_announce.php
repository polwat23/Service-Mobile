...
if($lib->checkCompleteArgument(['id_announce'],$dataComing)){
	if($dataComing["priority"] == 'ask'){
		$insertResponseAnn = $conmssql->prepare("INSERT INTO logacceptannounce(member_no,id_announce,status_accept,id_userlogin)
		...
		$insertResponseAnn = $conmssql->prepare("INSERT INTO logacceptannounce(member_no,id_announce,id_userlogin)
