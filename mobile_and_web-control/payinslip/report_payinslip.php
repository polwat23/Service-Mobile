...
function GenerateReport($dataReport,$header,$lib){
	...
	$html .='
		...
		<div style="margin-top:-20px">
			...
			<div class="bold absolute" style="right: -15px; top:5px; font-size:14pt;" >
				<div class="bold right" style="font-size:14pt;">(1)</div>
		...
		<div class="border" style="margin-top:20px;">
			...
			<div style="padding-right:10px;" class="right">สาขา/Brance....................................&nbsp;&nbsp;  วันที่/Date................................</div>
			<div style="margin-left:60px;">
				<div class="bold" style="margin-top:-10px">สมาคมฌาปนกิจสงเคราะห์สมาชิกสหกรณ์ออมทรัพย์สาธารณสุขไทย</div>
				<div>ที่อยู่ 199/9 อาคารเพชรสะพานบุญ ถนนนครอินทร์</div>
				<div>ต.บางสีทอง อ.บางกรวย จ.นนทบุรี 11130</div>
				<div>โทรศัพท์ 02 496 1350 - 57 , 08 6372 9629 , 09 5412 9740</div>
			</div>
			<div style="margin-top:20px; margin-left:10px;">
				<div style="height:50px;">
					<div class="absolute" style="margin-top: 20px; width: 10px; height: 10px; border-color: #000; border-style: solid;"></div>
					<div style="margin-left:20px;">
						<img src="../../resource/logo/logo_kungthai.jpg" alt="" width="25" style="margin-left:5px; margin-right:5px; margin-top:20px;">
						<div class="absolute">
							เพื่อนำเข้าบัญชี  <b>สมาคมฌาปนกิจสงเคราะห์สมาชิกสหกรณ์ออมทรัพย์สาธารณสุขไทย</b>
							<div style="color: #FF0000;">บมจ.ธนาคารกรุงไทย  (รหัสหน่วยงาน/Company Code: 92777)  ค่าธรรมเนียม 10 บาทต่อรายการ</div>
						</div>
					</div>
				</div>
				<div style="height:40px;">
					<div class="absolute" style="margin-top: 7px; width: 10px; height: 10px; border-color: #000; border-style: solid;"></div>
					<div style="margin-left:20px;">
						<img src="../../resource/logo/counterservice_7-11.jpg" alt="" width="45px" style="margin-left:5px; margin-right:5px; margin-top:10px;">
						<div class="absolute">เคาน์เตอร์เซอร์วิส หรือ 7-ELEVEN (Service 01) <span style="color: #FF0000;">ค่าธรรมเนียม 10 บาทต่อรายการ</span></div>
					</div>
					<div class="absolute">
						<img src="../../resource/logo/Barcode.jpg" alt="" height="40px" style="margin-left:480px; margin-top:-50px;">
					</div>
					<div class="abolute">
						<img src="../../resource/logo/QRCODE.jpg" alt="" width="60px" style="margin-left:660px; margin-top:-50px;">
					</div>
				</div>
				<div style="height:40px;">
					<div class="absolute" style="width: 10px; height: 10px; border-color: #000; border-style: solid;"></div>
					<div style="margin-left:20px;margin-top: -5px;">
						<img src="../../resource/logo/visa-mastercard.png" alt="" width="45px" style="margin-left:5px; margin-right:5px;">
						<div class="absolute" style="margin-top: -5px;">บัตรเครดิต (Visa Card/master Card) คิดค่าบริการอัตราร้อยละ 1.25  จากจำนวนเงินที่ชำระ  <span style="color: #FF0000;">ค่าธรรมเนียม 10 บาทต่อรายการ</span></div>
					</div>
				</div>
			</div>
	...
	<div>
		...
		<div style="margin-top:0px">
			<div class="bold absolute" style="right:-15px; font-size:14pt; ">
				<div class="bold right" style="font-size:14pt;">(2)</div>
				โปรดเรียกเก็บค่าธรรมเนียมจากผู้ชำระเงิน*
			</div>
			<div class="header">	
				ใบนำฝากชำระเงินค่าสินค้าหรือบริการ (Bill Payment Pay-In Slip)
	...
	<div class="center">
		กรุณานำใบแจ้งหนี้ส่วนที่ 1 และ 2 ไปชำระเงินได้ ณ จุดบริการชำระเงินที่ระบุข้างต้นพร้อมชำระค่าธรรมเนียมตามอัตราที่ระบุไว้
		<div><b>หมายเหตุ :</b> ค่าธรรมเนียมอาจเปลี่ยนแปลงได้โปตรวจสอบอัตราค่าธรรมเนียมล่าสุด ณ จุดรับชำระเงินอีกครั้ง</div>
	</div>
	';
