...
function GenerateReport($dataReport,$header,$lib){
	...
	<div style="margin-top:20px;">
		...
		<div style="font-size: 22px;font-weight: bold; text-align:right; margin-right:30px; height: 45px;  padding-top:15px;">สหกรณ์ออมทรัพย์การไฟฟ้าฝ่ายผลิตแห่งประเทศไทย จำกัด</div>
	</div>
