...
if(($func->check_permission($payload["user_type"],'ChangePin' ,'ChangePin') && ($dataComing["menu_component"] == 'Pin') || $func->check_permission($payload["user_type"],$dataComing["menu_component"] ,'ChangePin') )){
