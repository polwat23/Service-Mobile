...
if($lineLib->checkBindAccount($user_id)){
	...
	if($memberInfoMobile->rowCount() > 0){
		...
		$meberAccountData["MEMBGROUP_CODE"] = $rowMember["membgroup_code"];
	...
	if($memberInfoMobile->rowCount() > 0){
		...
		*/
		$meberInforData["contents"]["body"]["contents"][5]["type"] = "filler";
		/*
		...
		*/
		$meberInforData["contents"]["body"]["contents"][6]["type"] = "filler";
		...
		$meberInforData["contents"]["body"]["contents"][11]["type"] = "filler";
		$meberInforData["contents"]["body"]["contents"][12]["type"] = "filler";
		/*
		...
		*/
		...
		$meberInforData["contents"]["body"]["contents"][13]["text"] = "ส่วนรับเงิน";
		...
		$meberInforData["contents"]["body"]["contents"][14]["contents"][0]["text"] = ($meberAccountData["MEMBERGROUP_DESC"]??"-").($meberAccountData["MEMBGROUP_CODE"]??null);
