...
if($checkBeenBind->rowCount() > 0){
	...
	$dataContent["body"]["contents"][3]["color"] = "#E3519D";
	...
	$dataContent["contents"][0]["header"]["contents"][0]["text"] = "ผูกบัญชีกับ NKBKConnext";
	...
	$dataContent["contents"][0]["body"]["contents"][0]["text"] = "หากใช้งาน Line บนคอมพิวเตอร์ให้ใช้ แอปพลิเคชัน NKBKConnext เข้าเมนูสแกน QR Code แล้วสแกน";
