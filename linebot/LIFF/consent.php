...
$checkBindAccount = $conmysql->prepare("SELECT menu_status FROM gcmenu									
									WHERE menu_parent = '-1'
								        and menu_channel = 'both'");
	...
	<div class="box-consent">
		<div class="row" >
			<div class="center" style="color:#0d6efd; text-align:center; font-weight:bold; margin-top:20px;">
				...
				<?php echo'<script>console.log($("#nameline"))</script>';?>
			</div>
		
			<div class="content-text">
				ข้าพเจ้าสมาชิกสหกรณ์ฯ (เจ้าของข้อมูล)ยินยอมให้สหกรณ์ เก็บ รวบรวม ใช้เปิดเผยข้อมูลของข้าพเจ้า ดังต่อไปนี้
			</div>
			<iframe src="https://cdn.thaicoop.co/consent/concent.html" style="height:360px; width:100%;" title="consent"></iframe>
			<!--
