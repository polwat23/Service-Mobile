...
}else if($message == "เมนูทั้งหมด" || $message == "เมนูสหกรณ์"  ){
...
}else if($message == "สิทธิกู้โดยประมาณ"){
	require_once('./service/loan_creadit.php');
