...
$fetchDataSTM = $conoracle->prepare("SELECT SHS.SEQ_NO,SHS.OPERATE_DATE,TRIM(SHS.MEMBER_NO) as MEMBER_NO,(SHS.SHARE_AMOUNT * 10) AS AMOUNT,
												...
												WHERE SHS.OPERATE_DATE BETWEEN (SYSDATE - 3) and SYSDATE AND SHS.SYNC_NOTIFY_FLAG = '0' 
												AND SHS.SHRITEMTYPE_CODE IN(".implode(',',$arrayStmItem).")");
