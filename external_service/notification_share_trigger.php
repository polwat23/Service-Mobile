...
$fetchDataSTM = $conoracle->prepare("SELECT SHS.SEQ_NO,SHS.OPERATE_DATE,SHS.MEMBER_NO,(SHS.SHARE_AMOUNT * 50) AS AMOUNT,
												(SHS.SHARESTK_AMT * 50) AS SHARE_BALANCE,SHI.SHRITEMTYPE_DESC
