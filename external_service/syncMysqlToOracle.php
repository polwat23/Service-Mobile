...
/*$columnArr = ['corepermissionsubmenu','coremenu**','corepermissionmenu**','coresectionsystem**','coresubmenu**','coreuser**','coreuserlogin','csbankdisplay','gcannounce',
