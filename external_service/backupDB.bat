...
c:
cd C:\Program Files\MariaDB 10.5\bin & mysqldump.exe -hlocalhost -P3306 -u root -p@Egat2020 mobile_egat > D:\EgatscMobile\Service-Egat\external_service\backupDB_egat.sql
