...
cd C:\Program Files\MariaDB 10.5\bin & mysqldump.exe -hlocalhost -P3306 -u root -p@MUsaving2020 mobile_mhd > C:\Mobile\Service-MHD\external_service\backupDB_mhd.sql
