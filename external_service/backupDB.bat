...
set DBUSER=root
set DBPASS=@SPT2021
set DBNAME=mobile_spt_test
set PROJECT_PATH=C:\Mobile\service-spt-test\
...
:: "C:\Program Files\7-Zip\7z.exe" a -r %BACKUP_PATH%%today%_resource.zip %PROJECT_PATH%resource
