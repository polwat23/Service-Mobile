...
set DBNAME=mobile_ktscc_test
set PROJECT_PATH=C:\Mobile\service-ktscc-test\
...
"C:\Program Files\7-Zip\7z.exe" a -r %BACKUP_PATH%%today%_doc.zip %PROJECT_PATH%resource\reqloan_doc
