...
set DBUSER=root
set DBPASS=@MJU2020
set DBNAME=mobile_mju_test
set PROJECT_PATH=C:\Mobile\service-mju-test\
...
IF EXIST %PROJECT_PATH%resource\openaccounts "C:\Program Files\7-Zip\7z.exe" a -r %BACKUP_PATH%%today%_doc.zip %PROJECT_PATH%resource\openaccount
