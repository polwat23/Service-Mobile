...
foreach($filelist as $name){
	if (!in_array($name,array(".","..",'.gitignore')) && strpos($name,'.') !== FALSE){
			...
			$dest = 'D:/Mobile/service-hnd/resource/avatar/'.$fileInfo[0].'/'.$name;
			rename('D:/Mobile/service-hnd/resource/avatar/'.$name,$dest);
			$webP_destination = 'D:/Mobile/service-hnd/resource/avatar/'.$fileInfo[0].'/'.$fileInfo[0].'.webp';
