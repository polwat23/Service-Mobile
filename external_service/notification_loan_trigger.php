...
$fetchDataSTM = $conmssql->prepare("SELECT LUT.LOANITEMTYPE_DESC,LCN.LOANCONTRACT_NO,LCN.OPERATE_DATE,LCM.MEMBER_NO,LCN.SEQ_NO,
									...
									WHERE lcn.operate_date BETWEEN (GETDATE() - 20) and GETDATE() and (lcn.sync_notify_flag IS NULL OR lcn.sync_notify_flag = '0') and lcn.loanitemtype_code IN(".implode(',',$arrayStmItem).")");
