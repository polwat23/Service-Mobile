...
$fetchDataSTM = $conoracle->prepare("SELECT lut.loanitemtype_desc,lcn.loancontract_no,lcn.OPERATE_DATE,TRIM(lcm.member_no) as member_no,lcn.seq_no,
									...
									WHERE lcn.operate_date BETWEEN (SYSDATE - 2) and SYSDATE and lcn.sync_notify_flag = '0' 
									and lcn.loanitemtype_code IN(".implode(',',$arrayStmItem).")");
