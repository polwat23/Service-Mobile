...
$fetchDataGuarantee = $conmssql->prepare("SELECT MP.PRENAME_DESC + MB.MEMB_NAME + ' ' + MB.MEMB_SURNAME AS FULL_NAME,
										...
										WHERE lcm.startcont_date BETWEEN (GETDATE() - 50) and GETDATE() and (lcc.sync_notify_flag IS NULL OR lcc.sync_notify_flag = '0') and lcc.coll_status = '1' and lcm.contract_status = '1' and lcc.loancolltype_code = '01'");
