...
$templateMessage = $func->getTemplateSystem('AssistBodMember',1);
if(isset($templateMessage)){
	$queryTarget = $conoracle->prepare("SELECT assistslip_no,member_no,slip_date,payoutnet_amt 
										FROM assslippayout where EXTRACT(year from slip_date) = EXTRACT(year from sysdate) and 
										assisttype_code = '70' and slip_status = '1' and sync_notify_flag = '0' and member_no = '00017583'");
	$queryTarget->execute();
